<?php
// Edit product - same as add_product but with ID parameter
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Make slug unique
    $slugCheck = $conn->query("SELECT id FROM products WHERE slug = '$slug' AND id != $id");
    ...
    if ($conn->query($sql)) {
        ...
        setFlashMessage('Error updating product', 'danger');
    }
}
?>
<!DOCTYPE html>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input type="checkbox" name="featured" class="form-check-input" id="featured" <?php echo $product['featured'] ? 'checked' : ''; ?>>
